...
from src.installers.cursor.mac.system_prompt_updater import CursorMacSystemPromptUpdater
...
class CursorMacInstaller(BaseInstaller):
    ...
    def __init__(self):
        try:
            super().__init__()
            self.set_objects(CursorMacYOLOEnabler, CursorMacMCPConfigEditor, CursorMacSystemPromptUpdater)
